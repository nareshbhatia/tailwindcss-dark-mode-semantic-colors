...
const variantStyles: { [variant: string]: string } = {
  ...
  secondary:
    'inline-flex items-center rounded-md border border-transparent px-8 py-2 text-lg font-semibold bg-brand-secondary text-onbrand-secondary hover:bg-brand-secondary-hover focus:outline-none focus:ring-2 focus:ring-brand-secondary focus:ring-offset-2',
};
